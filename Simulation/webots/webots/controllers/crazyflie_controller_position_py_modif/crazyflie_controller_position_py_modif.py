...
x_ini = float(matriz_datos[0][2])
y_ini = float(matriz_datos[0][3])
z_ini = float(matriz_datos[0][4])  
angle_ini = float(matriz_datos[0][5])
...
if __name__ == '__main__':
    ...
    while robot.step(timestep) != -1:
        ...
        if error_pos>abs(x_global-desired_state[0]) and error_pos>abs(y_global-desired_state[1]) and error_pos>abs(altitude-desired_state[2]) and n_filas>i-1:
            print(altitude-desired_state[2])
            i=i+1
        ...
        desired_state[0]=float(matriz_datos[i][2])
        desired_state[1]=float(matriz_datos[i][3])
        desired_state[2]=float(matriz_datos[i][4])
        desired_state[3]=float(matriz_datos[i][5])
