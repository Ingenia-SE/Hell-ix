...
% ========================================================================
% - Author: Will Robertson and The University of Adelaide
...
% Description:
% ========================================================================
% This code can be used  to draw cubic  splines in Matlab by only entering 
% the  points  through which the spline  should  pass. Control  points are 
% calculated  automatically  using the  algorithm of  Hobby  (1986), which 
% allows a slope and "tension" of the spline to be  specified instead. The 
% algorithm  has  been extended  into  3D  in a  similar  fashion  as  the 
% Asymptote software by John Bowman et al. (2008).
% 
% - References: 
%   > Hobby (1986) "Smooth, easy to compute interpolating splines"
%     <http://www.springerlink.com/content/p4w1k8w738035w80/>
%   > John C. Bowman and Andy Hammerlindl (2008) "Asymptote: A vector 
%     graphics language"
...
if debug
  ...
  for ii = 1:Mpoints
    plot3(z{ii}(1),z{ii}(2),z{ii}(3),'o','color','cyan')
    text(z{ii}(1),z{ii}(2),z{ii}(3),['   ',num2str(ii)], 'color', 'white')
  end
end
...
function plot_bezier(P1,P2,P3,P4,linestyle,ii)
global trajectory
